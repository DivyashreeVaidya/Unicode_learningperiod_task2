...
function Navbar() {
  ...
  const renderMenu = (
    <Menu
      ...
      >
      <MenuItem  onClick={handleMenuClose}><Link style={navStyle} to='/tracks'>Tracks</Link></MenuItem>
      <MenuItem  onClick={handleMenuClose}><Link style={navStyle} to='/albums'>Albums</Link></MenuItem>
      <MenuItem  onClick={handleMenuClose}><Link style={navStyle} to='/playlists'>Playlists</Link></MenuItem>
    </Menu>
  );
